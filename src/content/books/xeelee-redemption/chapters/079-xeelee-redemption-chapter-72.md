...
chapterNumber: 79
slug: "xeelee-redemption-chapter-72"
title: "72"
...
He looked into her enigmatic face, a mixture of human and Ghost he could barely read, even now. ‘Take it easy? I’m scared, Nicola.’
...
‘I know . . . I suspect it is real, in some sense,’ Poole said. ‘A true image of the artefact, not some simulation. Given that to ask what is “true”, what is “real”, what is there “now”, is only going to produce unsatisfactory answers across intervals of millions of light years. But I don’t think this is another Xeelee transit system – another super-wormhole. I think this is some kind of viewer. Like a light pipe maybe. The Xeelee can see where its fellows are, has been able to watch the construction of this ring. Obviously useful. But it can only get there using its faster-than-light drive, when the construction is done.’
...
Chinelo was nothing if not practical; she seemed to move on from that conceptual nightmare without skipping a beat. ‘So,’ she said. ‘What do we do now? If we went all around this – tesseract – and we didn’t find the Xeelee – oh, but we didn’t see it all.’
