...
Die Formel, daß der Produktionspreis einer Ware = k + p, gleich Kostpreis plus Profit ist, hat sich jetzt näher dahin bestimmt, daß p = kp´ ist (wo p´ die allgemeine Profitrate), und daher der Produktionspreis = k + kp´. Ist k = 300 und p´ = 15%, so ist der Produktionspreis k + kp´ = 300 + 300<sup>15</sup>/100 = 345.
